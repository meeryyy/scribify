...
<html class="" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
                  .gradient {
        background: linear-gradient(90deg, #442851 0%, #5e3e6d 100%);
      }
        </style>
        ...
        <body class="leading-normal tracking-normal text-white gradient " style="font-family: 'Source Sans Pro', sans-serif;">
          ...
          <div class="pt-52">
              <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                <!--Left Col-->
                <div class="flex flex-col mt-5 w-full md:w-2/5 justify-center items-start text-center md:text-left">
                  <h1 class="my-4 text-5xl font-bold leading-tight">
                    Hi, we're <br> Scribify
                    </h1>
                  <p class="leading-normal text-2xl mb-8">
                    Where Every Tale Finds a Home
                  </p>


                </div>
                <!--Right Col-->
                <div class="w-full md:w-3/5 py-6 text-center -mt-24">
                  <img class="w-full md:w-4/5 z-50" src="images/welcome.png" />
                </div>
              </div>
            </div>
            ...
            <section class="bg-white border-b py-8">
              <div class="container max-w-5xl mx-auto m-8">
                ...
                <h2 class="w-full -mt-24 text-4xl font-bold leading-tight text-center text-gray-800">
                    <a href="{{route('login')}}">
                ...
                <div class="flex flex-wrap">
                  <div class="w-5/6 sm:w-1/2 p-6">
                    ...
                    <p class="text-gray-600 mb-8 mt-5">
                       The ultimate platform for collaborative writing. Here, every word matters, and every pen holds the power to weave extraordinary tales. Immerse yourself in a realm where writing becomes a collective adventure. Scribify provides a space where authors come together to breathe life into unique narratives. Join us in this passionate community where stories come alive, one sentence at a time. Ready to write the future with us?.

                    </p>
                  </div>
                  <div class="w-full sm:w-1/2 p-6 ">
                    <img class="w-60" src="{{asset('images\scribifylogo.png')}}" alt="">
                  </div>
                </div>
                <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                  ...
                  <div class="w-full sm:w-1/2 p-6 mt-6">
                    <div class="align-middle">
                      <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                        Connected World                      </h3>
                      <p class="text-gray-600 mb-8 mt-10">
                        In our dedicated space for collaborative writing, step into the connected world of literary creation. Here, borders blur, giving way to a global community of passionate writers.
            ...
            <section class="container mx-auto text-center py-6 mb-12">
              <h2 class="w-full my-2 text-5xl font-bold leading-tight text-center text-white">
                Take Scribify with you
            </h2>
              <div class="w-full mb-4">
                <div class="h-1 mx-auto bg-white w-1/6 opacity-25 my-0 py-0 rounded-t"></div>
              </div>
              <div class="mx-36 -mt-20 -mb-16 ">
                <img class="" src="{{asset('images/welcome.png')}}" alt="">
              </div>
